...
sudo echo "q_database_host='master.breakfastclub.com'" >> answer_file.txt
...
sudo echo "q_public_hostname='master.breakfastclub.com'" >> answer_file.txt
...
sudo echo "q_puppet_enterpriseconsole_master_hostname='master.breakfastclub.com'" >> answer_file.txt
sudo echo "q_puppetagent_certname='master.breakfastclub.com'" >> answer_file.txt
sudo echo "q_puppetagent_install='y'" >> answer_file.txt
sudo echo "q_puppetagent_server='master.breakfastclub.com'" >> answer_file.txt
...
sudo echo "q_puppetdb_hostname='master.breakfastclub.com'" >> answer_file.txt
...
sudo echo "q_puppetmaster_certname='master.breakfastclub.com'" >> answer_file.txt
sudo echo "q_puppetmaster_dnsaltnames='puppet,masterevilcorp,master.breakfastclub.com'" >> answer_file.txt
sudo echo "q_puppetmaster_enterpriseconsole_hostname='master.breakfastclub.com'" >> answer_file.txt
...
sudo wget 'http://192.168.1.6:8080/downloads/puppet-enterprise-2015.2.0-ubuntu-14.04-amd64.tar.gz'
